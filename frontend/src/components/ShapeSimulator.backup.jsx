        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
              ...
              <div className="relative aspect-[4/5] bg-gradient-to-br from-[#0D1117] via-[#151B23] to-[#0D1117] rounded-3xl overflow-hidden border border-white/5 shadow-2xl backdrop-blur-xl">
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-3 bg-black/40 backdrop-blur-xl rounded-full px-6 py-3 border border-white/10">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-400 font-medium">SIMULAÇÃO ATIVA</span>
                  </div>
            ...
            <div className="text-center">
              <p className="text-gray-500 mb-8 text-lg font-light max-w-2xl mx-auto">
                Transforme essa simulação em <span className="text-transparent bg-gradient-to-r from-[#FF6A3D] to-[#FF1493] bg-clip-text font-semibold">realidade comprovada</span>
              </p>
              <button className="group relative px-12 py-5 bg-gradient-to-r from-[#FF6A3D] to-[#FF1493] rounded-full font-bold text-white text-lg shadow-2xl hover:shadow-[0_0_60px_rgba(255,106,61,0.5)] transition-all duration-500 hover:scale-105 overflow-hidden">
                <span className="relative z-10 flex items-center gap-3 justify-center">
                  Quero transformar essa simulação em realidade
